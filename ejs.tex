...
\runtitle{Approximately Exact Calculations}

\begin{aug}

\author{ \fnms{Michael} \snm{Lavine}  \ead[label=e1]{lavine@math.umass.edu} }
\address{Department of Mathematics and Statistics\\ UMass Amherst\\ Amherst, MA 01003\\ USA}
\printead{e1}

\author{ \fnms{Andrew} \snm{Bray}  \ead[label=e2]{abray@reed.edu} }
\address{Reed College\\ 3203 Southeast Woodstock Boulevard\\ Portland, Oregon 97202-8199\\ USA}
\printead{e2}

\author{ \fnms{Jim} \snm{Hodges}  \ead[label=e3]{hodge003@umn.edu} }
...
\paragraph{\textcompute{findf}: The main function}
...
%\paragraph{\textcompute{killfunc}: determine whether to make a box inactive}
%\begin{verbatim}
%# conditions under which a box becomes inactive
%killfunc <- function(box, lb, M, eps, delE, delS, ratio) {
