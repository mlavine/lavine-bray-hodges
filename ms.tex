...
\end{description}
\textbf{D1} and \textbf{D2} will allow us to divide the $(\sigesq,\sigssq)$ plane into two parts: one where $\logRL$ is low and another where we know $\logRL$ to within a pre-specified $\epsilon$.  The next section shows how the partial derivatives are used to satisfy \textbf{D1} and \textbf{D2}.
